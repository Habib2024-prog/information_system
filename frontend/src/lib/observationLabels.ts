...
export function getFinalResultLabel(code: string | null, type: "teacher" | "amir_senior_teacher") { if (!code) return "—"; return (type === "teacher" ? teacherFinalLabels : amirFinalLabels)[code] ?? "نامشخص"; }
